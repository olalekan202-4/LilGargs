...
function App() {
  ...
  const handlePurchase = (itemId, price) => {
    if (unclaimedGarg < price) {
      showMessage(
        "You do not have enough $GARG to purchase this item.",
        "error"
      );
      return;
    }
    ...
    if (itemId === "flair") {
      setPurchasedFlairs((prev) => ({
        ...prev,
        [wallet.publicKey.toBase58()]: true,
      }));
    ...
    if (itemId === "raffle") {
      console.log(
        `User ${wallet.publicKey.toBase58()} purchased a raffle ticket.`
      );
          ...
          {wallet.connected ? (
                ...
                {livePhase ? (
                  ...
                  >
                    ...
                    <p className="text-gray-400 mt-2">
                      Please check back later for details on the next minting
                      phase.
                    </p>
                  </motion.div>
                )}
            ...
            >
              ...
              <p className="text-gray-400 mt-2 max-w-xl mx-auto">
                Join the Gargoyle rebellion. Connect your wallet to mint new
                OGs, view your collection, and start mining $GARG.
              </p>
            </motion.div>
          )}
        </div>
