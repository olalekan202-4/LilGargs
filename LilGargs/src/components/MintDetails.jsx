            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                ...
                <div className="md:col-span-2 text-center md:text-left">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start gap-4 text-lg mb-6">
                        <motion.div whileHover={{ scale: 1.05 }} className="bg-gray-700/50 p-4 rounded-lg transition-transform">
                            <span className="font-bold text-cyan-400">Available:</span>
                            <span className="ml-2 text-white font-mono">{availableSupply}</span>
                        </motion.div>
                        <motion.div whileHover={{ scale: 1.05 }} className="bg-gray-700/50 p-4 rounded-lg transition-transform">
                            <span className="font-bold text-purple-400">Total Supply:</span>
                            <span className="ml-2 text-white font-mono">{supply || 'N/A'}</span>
                        </motion.div>
                        <motion.div whileHover={{ scale: 1.05 }} className="bg-gray-700/50 p-4 rounded-lg transition-transform">
