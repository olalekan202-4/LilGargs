        ...
        <footer className="bg-gray-900/50 border-t border-gray-700/50 mt-16">
            <div className="container mx-auto py-8 px-4 text-center text-gray-400">
                ...
                <div className="flex justify-center items-center gap-8 my-8">
                    <a href="https://discord.gg/HzsdJ8fd6M" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-400 transition-colors" aria-label="Twitter">
                        <TwitterIcon />
                    </a>
                    <a href="https://discord.gg/HzsdJ8fd6M" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-400 transition-colors" aria-label="Discord">
                        <DiscordIcon />
                    </a>
                </div>
